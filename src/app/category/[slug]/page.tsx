...
const getCategoryBySlug = (slug: string) => {
  const categories = {
    'clothing': {
      name: 'Clothing',
      description: 'Discover our curated collection of premium women\'s clothing, from elegant dresses to comfortable everyday essentials.',
    ...
    'footwear': {
      name: 'Footwear',
      description: 'Step into style with our selection of premium footwear, from elegant heels to comfortable flats and casual sneakers.',
    ...
    'accessories': {
      name: 'Accessories',
      description: 'Complete your look with our elegant accessories, from statement jewelry to functional bags and scarves.',
    ...
    'beauty': {
      name: 'Beauty',
      description: 'Enhance your natural beauty with our premium skincare, makeup, and fragrance products.',
      image: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?q=80&w=1000&auto=format&fit=crop',
      subcategories: ['Skincare', 'Makeup', 'Fragrance', 'Hair Care', 'Bath & Body'],
    },
    'lifestyle': {
      name: 'Lifestyle',
      description: 'Elevate your everyday with our curated selection of home decor, stationery, and wellness products.',
    ...
    'new-arrivals': {
      name: 'New Arrivals',
      description: 'Be the first to discover our latest additions, featuring the newest trends and seasonal must-haves.',
    ...
    <div>
      ...
      <div className="relative h-[40vh] flex items-center">
        ...
        <div className="g-container relative z-10 text-white">
          <h1 className="g-heading text-4xl md:text-5xl mb-4">{category.name}</h1>
                ...
                <div className="space-y-2">
                  {category.subcategories.map((subcategory) => (
                    <label key={subcategory} className="flex items-center">
                      ...
                      />
                      <span className="ml-2 text-neutral-800">{subcategory}</span>
                    </label>
                  ))}
                </div>
              </div>
