      ...
      <div className="bg-white rounded-md shadow-soft p-8 mb-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-neutral-700 mb-8">
              We're here to help with any questions or concerns you may have. Our customer service team is available Monday through Friday, 9am to 5pm EST.
            </p>
            ...
            <div className="space-y-8">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <a href="mailto:info@graceandcarry.com" className="text-primary hover:underline">
                    info@graceandcarry.com
                  </a>
                  <p className="text-neutral-600 mt-2 mb-1">For customer support:</p>
                  <a href="mailto:support@graceandcarry.com" className="text-primary hover:underline">
        ...
        <div className="mt-12">
          ...
          <p className="text-neutral-700 mb-6">
            Find quick answers to common questions on our <Link href="/faq" className="text-primary hover:underline">FAQ page</Link>.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="border border-neutral-200 rounded-md p-4">
              ...
              <p className="text-neutral-600">
                We offer standard, express, and overnight shipping options. Free standard shipping on orders over $100.
              </p>
              <Link href="/shipping" className="text-primary hover:underline text-sm mt-2 inline-block">
                Learn more
              </Link>
            </div>
            ...
            <div className="border border-neutral-200 rounded-md p-4">
              ...
              <p className="text-neutral-600">
                We provide detailed size guides for all our products to help you find your perfect fit.
              </p>
              <Link href="/size-guide" className="text-primary hover:underline text-sm mt-2 inline-block">
                View size guide
              </Link>
            </div>
          </div>
