    ...
    <div className="g-container py-12">
      ...
      <div className="bg-white rounded-md shadow-soft p-8 mb-8">
        ...
        <p className="text-neutral-700 mb-6">
          At Grace & Carry, we're committed to providing exceptional customer service. 
        ...
        <p className="text-neutral-700 mb-6">
          Find quick answers to our most commonly asked questions. For more detailed information, 
          please visit our <Link href="/faq" className="text-primary hover:underline">FAQ page</Link>.
        </p>
        ...
        <div className="space-y-4 mb-8">
          <div className="border border-neutral-200 rounded-md p-4">
            ...
            <p className="text-neutral-600">
              ...
              and overnight shipping. Free standard shipping is available on all orders over $100.
              For more information, please visit our <Link href="/shipping" className="text-primary hover:underline">Shipping & Returns page</Link>.
            </p>
          </div>
        ...
        <div className="text-center">
          <p className="text-neutral-700 mb-4">
            Can't find what you're looking for? Contact us directly or visit our comprehensive FAQ page.
          </p>
