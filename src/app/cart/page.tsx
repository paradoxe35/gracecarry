        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-md shadow-soft overflow-hidden">
              ...
              {/* Continue shopping */}
              <div className="p-4">
                <Link href="/category/new-arrivals" className="text-primary hover:underline flex items-center">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-md shadow-soft p-6">
              ...
              <div className="mb-6">
                ...
                {promoApplied && (
                  <p className="text-primary text-sm mt-1">Promo code applied successfully!</p>
                )}
              </div>
