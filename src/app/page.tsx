    ...
    <div>
      ...
      <section className="relative h-[80vh] flex items-center">
        ...
        <div className="g-container relative z-10 text-white">
          <div className="max-w-xl">
            <h1 className="g-heading text-4xl md:text-5xl lg:text-6xl mb-4">Elegance in Every Detail</h1>
            <p className="text-lg md:text-xl mb-8">Discover our new collection of sophisticated styles for the modern woman.</p>
            <div className="flex flex-wrap gap-4">
              <Link href="/category/new-arrivals" className="g-button-primary">Shop New Arrivals</Link>
              <Link href="/collections" className="bg-transparent text-white border border-white px-6 py-3 rounded-md hover:bg-white hover:text-neutral-900 transition-colors duration-300 font-medium">Explore Collections</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-neutral-100">
        <div className="g-container">
          <h2 className="g-heading text-3xl text-center mb-12">Shop by Category</h2>
      ...
      <section className="py-16">
        <div className="g-container">
          <div className="flex justify-between items-center mb-12">
            ...
            <Link href="/products" className="text-primary hover:text-primary-dark flex items-center">
              View All
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredProducts.map((product) => (
              <Link key={product.id} href={`/product/${product.id}`} className="g-card group">
                <div className="relative h-80 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4 z-10">
                    <button className="bg-white rounded-full p-2 shadow-soft hover:shadow-medium transition-shadow">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-neutral-700 hover:text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section className="py-16 bg-neutral-100">
        <div className="g-container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="g-heading text-3xl mb-4">Summer Collection 2025</h2>
              <p className="text-neutral-700 mb-6">
                Discover our latest summer collection featuring lightweight fabrics,
                breathable designs, and vibrant colors perfect for the season.
              </p>
              <Link href="/collections/summer" className="g-button-primary inline-block">
                Explore Collection
              </Link>
            </div>
