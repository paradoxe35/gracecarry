...
export default function AccountElement({customer}: { customer: StoreCustomerWithOrders }) {
    const t = useTranslations('AccountPage');
    const userData = {...customer, firstName: customer.first_name, lastName: customer.last_name, email: customer.email, phone: customer.phone};
                ...
                <nav className="p-2">
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 rounded-md transition-colors ${
                      activeTab === 'profile' ? 'bg-primary/10 text-primary' : 'hover:bg-neutral-100'
                    }`}
                  >
                    <div className="flex items-center">
                  ...
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 rounded-md transition-colors ${
                      activeTab === 'orders' ? 'bg-primary/10 text-primary' : 'hover:bg-neutral-100'
                    }`}
                  >
                    <div className="flex items-center">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 rounded-md transition-colors ${
                      activeTab === 'addresses' ? 'bg-primary/10 text-primary' : 'hover:bg-neutral-100'
                    }`}
                  >
                    <div className="flex items-center">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 rounded-md transition-colors ${
                      activeTab === 'wishlist' ? 'bg-primary/10 text-primary' : 'hover:bg-neutral-100'
                    }`}
                  >
                    <div className="flex items-center">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
